...
import {ExplorerHome} from "./SecretExplorer/ExplorerHome";
...
const customRoutes = (
  ...
  const backendRoutes = [
    ...
    <Route key="secret-explorer" exact path="/secret-explorer">
      <ExplorerHome currency={currency} initialView={credView} />
    </Route>,
